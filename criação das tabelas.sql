...
CREATE TABLE Pagamento( id integer UNIQUE, aluguel_id pagamento NOT NULL, finaceiro_id integer NOT NULL, quadra_id integer NOT NULL, cliente_id integer NOT NULL, data date NOT NULL, valor float NOT NULL, statusPagamento varchar(100) NOT NULL, PRIMARY KEY(id) );

CREATE TABEL Adm( id integer UNIQUE, adm boolean, CPF integer NOT NULL, nome varchar(100) NOT NULL, sobrenome varchar(100) NOT NULL, endereco_id integer NOT NULL, ativo boolena NOT NULL, PRIMARY KEY(id) );
...
CREATE TABLE Financeiro( id integer UNIQUE, Pagamento_Saida_id integer NOT NULL, DataBalanco date NOT NULL, valorEntrada moneyNOT NULL, descricao text, PRIMARY KEY(id) );

CREATE TABLE Telefone( proprietario_id integer NOT NULL, id integer UNIQUE, DD integer NOT NULL, numero integerNOT NULL, tipo varchar(100), PRIMARY KEY(id) );
